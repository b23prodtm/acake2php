...
- commits:
    - author: Akis Kesoglou
      body: >-
        Balena is the new name for resin-os/docker, so identify it in a
...
- commits:
    - author: Akis Kesoglou
      body: >-
        Balaena provides all required progress info its stream of events. Try to
...
- commits:
    - author: Akis Kesoglou
      ...
      footers:
        ...
        connects-to: '#32'
        refs: >-
          https://github.com/resin-os/balaena/blob/f55283222c05345540a0654cea2ef15031909806/distribution/pull_v2.go#L230
...
- commits:
    - author: Pablo Carranza Velez
      ...
      subject: >-
        Avoid calling the docker API to check if the dockerToolbelt option is
        valid
...
- commits:
    - author: Pablo Carranza Velez
      ...
      subject: >-
        Allow passing a dockerToolbelt object in the options, and update
...
- commits:
    - author: Akis Kesoglou
      ...
      subject: >-
        Fixed parsing Docker version when trying to decide which progress
...
- commits:
    ...
    - author: Alexios Theodoros Brezas
      body: >-
        Keep track of pushed size per layer and report one total percentage,

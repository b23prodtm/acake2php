...
getBalenaSdk(options).then((balena) => {
    const preloader = new preload.Preloader(balena, new Docker({ Promise }), options.appId, options.commit, options.image, options.splashImage, options.proxy, options.dontCheckArch, false, options.certificates);
...
//# sourceMappingURL=balena-preload.js.map
...
exports.validateVersion = exports.resolveVersion = exports.getDeviceType = exports.getFileCreatedDate = void 0;
 ...
 */
async function getFileCreatedDate(file) {
    const { ctime } = await fs_1.promises.stat(file);
    return ctime;
}
 ...
 */
async function resolveVersion(deviceType, versionOrRange) {
    const version = await balena.models.os.getMaxSatisfyingVersion(deviceType, versionOrRange);
    if (!version) {

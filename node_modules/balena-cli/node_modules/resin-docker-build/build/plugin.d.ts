 ...
 */
export declare type ValidHook = 'buildStream' | 'buildSuccess' | 'buildFailure';
...
export interface BuildHooks {
     ...
     */
    buildSuccess?: (imageId: string, layers: string[], fromTags: FromTagInfo[]) => void;
    /**
     ...
     */
    buildFailure?: (error: Error, layers: string[], fromTags: FromTagInfo[]) => void;
}

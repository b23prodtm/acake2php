...
class SparseWriteStream extends readable_stream_1.Writable {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (true) {
                try {
                    ...
                    yield this.destination.write(chunk.buffer, 0, chunk.buffer.length, chunk.position);
                    if (!flushing) {
...
exports.ProgressSparseWriteStream = progress_1.makeClassEmitProgressEvents(SparseWriteStream, 'bytesWritten', 'position', constants_1.PROGRESS_EMISSION_INTERVAL);

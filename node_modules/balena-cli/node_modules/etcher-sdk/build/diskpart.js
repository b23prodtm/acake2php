...
const execFileAsync = (command, args = [], options = {}) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
const runDiskpart = (commands) => __awaiter(void 0, void 0, void 0, function* () {
    if (os_1.platform() !== 'win32') {
        return;
    }
    yield bluebird_1.using(tmp_1.tmpFileDisposer(false), (file) => __awaiter(void 0, void 0, void 0, function* () {
        yield fs_1.writeFile(file.path, commands.join('\r\n'));
        const { stdout, stderr } = yield execFileAsync('diskpart', [
            '/s',
            file.path,
        ]);
        debug('stdout:', stdout);
 ...
 *   .catch(...)
 */
exports.clean = (device) => __awaiter(void 0, void 0, void 0, function* () {
    if (os_1.platform() !== 'win32') {
        return;
    }

...
exports.tmpFile = (keepOpen = true) => __awaiter(void 0, void 0, void 0, function* () {
    let fd;
    let path;
    let ok = false;
...
exports.tmpFileDisposer = (keepOpen = true) => {
    return bluebird_1.resolve(exports.tmpFile(keepOpen)).disposer((result) => __awaiter(void 0, void 0, void 0, function* () {

...
class BlockDevice extends file_1.File {
    ...
    createSparseWriteStream() {
        return __awaiter(this, void 0, void 0, function* () {
            const stream = new sparse_write_stream_1.ProgressSparseWriteStream(this, os_1.platform() === 'win32' ? WIN32_FIRST_BYTES_TO_KEEP : 0);
            stream.on('finish', stream.emit.bind(stream, 'done'));
            return stream;
        });
    }
    _open() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (os_1.platform() !== 'win32') {
                ...
                yield unmountDisk(this.drive.device);
            }

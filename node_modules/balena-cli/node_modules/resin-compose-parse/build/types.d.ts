...
export declare type ByteValue = string;
export declare type DurationValue = string;
export declare type ListOfUniqueItems<T> = T[];
export declare type ListOrDict = ListOfUniqueItems<string> | Dict<Value>;
export declare type StringOrList = string | ListOfUniqueItems<string>;

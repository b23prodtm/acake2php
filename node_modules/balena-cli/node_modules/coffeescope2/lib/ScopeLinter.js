  ...
  module.exports = ScopeLinter = (function() {
    ...
    ScopeLinter.prototype.visitAssignment = function(destination, arg1) {
      ...
      this.newState(false, [], (function(_this) {
        return function() {
          var i, len, name, node, ref1, ref2, ref3, results, type;
          if ((ref1 = destination.constructor.name) === "Literal" || ref1 === "IdentifierLiteral") {
          ...
          ref2 = _this.definitions;
          results = [];
          for (i = 0, len = ref2.length; i < len; i++) {
            ref3 = ref2[i], name = ref3[0], node = ref3[1];

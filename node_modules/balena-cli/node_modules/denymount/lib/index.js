 ...
 * @param {String} [options.executablePath] - alternative path to the `denymount`
...
module.exports = function(disk, handler, options, callback) {
  ...
  var executablePath = options.executablePath || EXECUTABLE_PATH;
  var child = childProcess.execFile(executablePath, [

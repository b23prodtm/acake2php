...
DockerUtils = (function() {
  ...
  DockerUtils.prototype.checkForExistingImage = function(name) {
    return Promise["try"]((function(_this) {
      return function() {
        return _this.docker.getImage(name).inspect().then(function(imageInfo) {
          return true;
        })["catch"](function(err) {
          var statusCode;
  ...
  DockerUtils.prototype.checkForRunningContainer = function(name) {
    return Promise["try"]((function(_this) {
      return function() {
        return _this.docker.getContainer(name).inspect().then(function(containerInfo) {
          var ref, ref1;
  ...
  DockerUtils.prototype.buildImage = function(arg) {
    ...
    return Promise["try"]((function(_this) {
      return function() {
        ...
        return _this.docker.buildImage(tarStream, {
          t: "" + name,
          cachefrom: cacheFrom
        });
      };
  ...
  DockerUtils.prototype.createContainer = function(name, arg) {
    ...
    return Promise["try"]((function(_this) {
      return function() {
        ...
        return _this.docker.getImage(name).inspect();
      };
      ...
      return function(imageInfo) {
        ...
        return _this.docker.createContainer({
          name: name,
          Image: name,
          Cmd: cmd,
  ...
  DockerUtils.prototype.startContainer = function(name) {
    return Promise["try"]((function(_this) {
      return function() {
        return _this.docker.getContainer(name).start();
      };
  ...
  DockerUtils.prototype.stopContainer = function(name) {
    return Promise["try"]((function(_this) {
      return function() {
        return _this.docker.getContainer(name).stop({
          t: 10
        });
      };
    })(this))["catch"](function(err) {
  ...
  DockerUtils.prototype.removeContainer = function(name) {
    return Promise["try"]((function(_this) {
      return function() {
        return _this.docker.getContainer(name).remove({
          v: true
        });
      };
    })(this))["catch"](function(err) {
  ...
  DockerUtils.prototype.removeImage = function(name) {
    return Promise["try"]((function(_this) {
      return function() {
        return _this.docker.getImage(name).remove({
          force: true
        });
      };
    })(this))["catch"](function(err) {
  ...
  DockerUtils.prototype.pipeContainerStream = function(name, outStream) {
    ...
    return Promise["try"]((function(_this) {
      return function() {
        ...
        return container.inspect().then(function(containerInfo) {
          var ref;
  ...
  DockerUtils.prototype.containerRootDir = function(container, host, port) {
    return Promise.all([this.docker.info(), this.docker.version().get('Version'), this.docker.getContainer(container).inspect()]).spread(function(dockerInfo, dockerVersion, containerInfo) {
  ...
  DockerUtils.prototype.isBalena = function() {
    return this.docker.version().get('Engine').then(function(engine) {

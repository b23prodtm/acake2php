...
const getOrganizationMembershipModel = function (deps, getOrganization) {
    ...
    const tagsModel = buildDependentResource({ pine }, {
        ...
        async getResourceId(membershipId) {
            // @ts-expect-error
    ...
    const exports = {
         ...
         * });
         */
        async get(membershipId, options = {}) {
         ...
         * });
         */
        async getAllByOrganization(handleOrId, options = {}) {
            const { id } = await getOrganization(handleOrId, {
                $select: 'id',
            });
            return await exports.getAll(util_1.mergePineOptions({ $filter: { is_member_of__organization: id } }, options));
        },
        /**

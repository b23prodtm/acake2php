...
const getDeviceModel = function (deps, opts) {
    ...
    const exports = {
        ...
        async getAllByApplication(nameOrSlugOrId, options) {
            ...
            return await exports.getAll(util_1.mergePineOptions({ $filter: { belongs_to__application: id } }, options));
        },
        /**
        ...
        async getAllByParentDevice(parentUuidOrId, options) {
            ...
            return await exports.getAll(util_1.mergePineOptions({ $filter: { is_managed_by__device: id } }, options));
        },
        /**
        ...
        async getWithServiceDetails(uuidOrId, options) {
            ...
            const device = await exports.get(uuidOrId, util_1.mergePineOptions({ $expand: device_service_details_1.getCurrentServiceDetailsPineExpand(true) }, options));
        ...
        async getByName(name, options) {
            ...
            const devices = await exports.getAll(util_1.mergePineOptions({ $filter: { device_name: name } }, options));
            if (devices.length === 0) {
        ...
        getLocalIPAddresses: async (uuidOrId) => {
            const { is_online, ip_address, vpn_address } = await exports.get(uuidOrId, { $select: ['is_online', 'ip_address', 'vpn_address'] });
            if (!is_online) {
         ...
         * });
         */
        getManifestBySlug: async (slugOrName) => {
            const deviceTypes = await configModel().getDeviceTypes();
        ...
        getManifestByApplication: async (nameOrSlugOrId) => {
            ...
            const app = (await applicationModel().get(nameOrSlugOrId, applicationOptions));
        ...
        async enableLocalMode(uuidOrId) {
            ...
            return await exports.configVar.set(device.id, local_mode_1.LOCAL_MODE_ENV_VAR, '1');
        },
        /**
         ...
         * });
         */
        isInLocalMode: async (uuidOrId) => {
            const value = await exports.configVar.get(uuidOrId, local_mode_1.LOCAL_MODE_ENV_VAR);
            return value === '1';
        },
        /**
        ...
        getTargetReleaseHash: async (uuidOrId) => {
            ...
            const { should_be_running__release, belongs_to__application, } = (await exports.get(uuidOrId, deviceOptions));
        ...
        pinToRelease: async (uuidOrId, fullReleaseHashOrId) => {
            ...
            if (util_1.isId(uuidOrId) && util_1.isId(fullReleaseHashOrId)) {
                ...
                const { id, belongs_to__application } = (await exports.get(uuidOrId, deviceOptions));
        ...
        setSupervisorRelease: async (uuidOrId, supervisorVersionOrId) => {
            ...
            if (util_1.isId(uuidOrId) && util_1.isId(supervisorVersionOrId)) {
                ...
                const device = (await exports.get(uuidOrId, deviceOpts));
        ...
        startOsUpdate: async (uuid, targetOsVersion) => {
            ...
            const device = (await exports.get(uuid, deviceOpts));
            device.uuid = uuid;
            // this will throw an error if the action isn't available
            exports._checkOsUpdateTarget(device, targetOsVersion);
            const osVersions = (await hostappModel().getAllOsVersions([
        ...
        tags: addCallbackSupportToModule({
            ...
            async getAllByApplication(nameOrSlugOrId, options) {
                ...
                return await tagsModel.getAll(util_1.mergePineOptions({
                    $filter: {
                        device: {
                            $any: {
                                $alias: 'd',
        ...
        configVar: addCallbackSupportToModule({
            ...
            async getAllByApplication(nameOrSlugOrId, options) {
                ...
                return await configVarModel.getAll(util_1.mergePineOptions({
                    $filter: {
                        device: {
                            $any: {
                                $alias: 'd',
        ...
        envVar: addCallbackSupportToModule({
            ...
            async getAllByApplication(nameOrSlugOrId, options) {
                ...
                return await envVarModel.getAll(util_1.mergePineOptions({
                    $filter: {
                        device: {
                            $any: {
                                $alias: 'd',

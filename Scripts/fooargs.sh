...
export MYSQL_DATABASE=foo_db
export DATABASE_USER=root
#; To override, shell parameter -p=<password> instead
export MYSQL_ROOT_PASSWORD=foo_pass
...
export MYSQL_USER=dummy_foo
#; To override, use shell parameter -t=<password> instead
export MYSQL_PASSWORD=foo_pass_test

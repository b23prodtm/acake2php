...
if (!isset($ClasseMenu)) {
        ...
        class Menu {
                 ...
                 * @param boolean $recursive false par d�faut, retourne les rubriques sous-jacentes
                 * * */
                ...
                /**
                 * Responsive CSS pour le support des �crans de petites tailles.
                 * par un clic utilisateur, le menu $IdName (clef <div class=$idName>) va s'afficher. 
                 * Un timeout va masquer le menu 3000 ms après.

...
if (filter_input(INPUT_GET, 'ajouter') === "publie" || filter_input(INPUT_GET, 'modifier') === "publie") {
        ...
        $date = getdate(time());
        $info = new Info($sql, $result, filter_input(INPUT_POST, 'i_titre' . $lang), filter_input(INPUT_POST, 'i_auteur'), filter_input(INPUT_POST, 'i_categorie'), $date['year'] . "-" . $date['mon'] . "-" . $date['mday']);

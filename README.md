...
>Note: Prefixed with *TEST_* they are used by the index.php?test=1 URLs

The following variables must be set up as server secrets environment, provided by your database administrator:

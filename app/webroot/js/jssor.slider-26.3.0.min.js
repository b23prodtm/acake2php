(function(j, h, c, g, d, k, e) { /*! Jssor */
	...
	var b = j.$Jssor$ = new function() {
		...
		function Ib() {
			if (!O) {
				O = {
					Ye: "ontouchstart" in j || "createTouch" in h
				};
				var a;
				if (E.pointerEnabled || (a = E.msPointerEnabled)) O.sd = a ? "msTouchAction" : "touchAction"
			}
			return O
		}
		...
		function Z(a) {
			a.constructor === Z.caller && a.oc && a.oc.apply(a, Z.caller.arguments)
		}
		i.oc = Z;
		i.$GetElement = function(a) {
			if (i.sg(a)) a = h.getElementById(a);
			return a
		};
		...
		i.zg = m("transformOrigin", 4);
		i.Uf = m("backfaceVisibility", 4);
		i.Tf = m("transformStyle", 4);
		i.Sf = m("perspective", 6);
		...
		i.dg = function(d, a) {
			if (a) d.style.clip = "rect(" + c.round(a.$Top || a.B || 0) + "px " + c.round(a.$Right) + "px " + c.round(a.$Bottom) + "px " + c.round(a.$Left || a.C || 0) + "px)";
			else if (a !== e) {
		...
		i.zc = function(a) {
			i.gg(i.$Children(a, d), a)
		};
		i.Qc = function(a, b) {
			var c = i.Rc(a);
			b & 1 && i.L(a, (i.$CssWidth(c) - i.$CssWidth(a)) / 2);
			b & 2 && i.I(a, (i.$CssHeight(c) - i.$CssHeight(a)) / 2)
		};
		var W = {
			$Top: g,
			$Right: g,
		...
		i.Yc = function(a, g, i, h) {
			if (h) a = Y(a);
			var c = X(a, g);
			if (!c.length) c = b.jg(a, g);
	...
	var m = {
		...
		q = j.$JssorSlideshowFormations$ = new function() {
			...
			h.$FormationStraight = function(f) {
				for (var d = f.$Cols, e = f.$Rows, s = f.$Assembly, t = f.Sb, r = [], a = 0, b = 0, p = d - 1, q = e - 1, h = t - 1, c, b = 0; b < e; b++)
					for (a = 0; a < d; a++) {
						switch (s) {
							case j:
								c = h - (a * e + (q - b));
	...
	j.$JssorSlideshowRunner$ = function(m, s, p, u, z, A) {
		...
		function j(h, e, g) {
			...
			t(a);
			a.Sb = a.$Cols * a.$Rows;
			a.$Easing = b.Bc(a.$Easing, f.$Linear);
			...
			a.fe = function(c, b) {
				...
				if (!a.Vb[f]) {
					...
					for (var d = 0; d < a.$Cols; d++)
						for (var e = 0; e < a.$Rows; e++) a.Vb[f][e + "," + d] = {
							$Top: e * b,
							$Right: d * c + c,
							$Bottom: e * b + b,
							$Left: d * c
	...
	j.$JssorBulletNavigator$ = function(a, E) {
		...
		f.Cc = function(x) {
			if (!w) {
				...
				for (var f = 0; f < u; f++) {
					var t = b.hg();
					b.$InnerText(t, f + 1);
					var k = b.Yc(h, "numbertemplate", t, d);
					b.K(k, "absolute");
					var p = f % (m + 1);
					b.L(k, !i ? n * p : f % j * n);
					b.I(k, i ? o * p : c.floor(f / (m + 1)) * o);
					b.$AppendChild(a, k);
					D[f] = k;
		...
		z = e.$SpacingY;
		i = e.$Orientation - 1;
		e.$Scale == k && n.R(a, m.Pb, 1);
		e.$AutoCenter && n.R(a, m.ob, e.$AutoCenter);
		n.dc(a)
	};
	j.$JssorArrowNavigator$ = function(a, e, i, A, z, x) {
		...
		function u() {
			s.$Enable(i.$Loop || !j.re(h));
			r.$Enable(i.$Loop || !j.oe(h))
		}
		c.Ac = function(c, a, b) {
			h = a;
			!b && u()
		...
		if (f.$AutoCenter) {
			n.R(a, m.ob, f.$AutoCenter);
			n.R(e, m.ob, f.$AutoCenter)
		}
		n.dc(a);
		n.dc(e)
	};
	j.$JssorThumbnailNavigator$ = function(f, E) {
		...
		function D(n, f) {
			...
			h.mb = f;
			h.Rd = o;
			j = n.Ce || n.nc || b.$CreateDiv();
			h.Qb = c = b.Yc(u, "thumbnailtemplate", j, d);
			m = b.gc(c);
		...
		l.Cc = function(F, G) {
			if (!C) {
				...
				j = j || c.ceil((B + q) / (w + q) * g + (z + r) / (v + r) * (1 - g));
				j = c.min(j, A);
				var u = w + (w + q) * (e - 1) * (1 - g),
					p = v + (v + r) * (e - 1) * g,
					o = u + (u + q) * (j - 1) * g,
		...
		r = a.$SpacingY;
		j = a.$Cols;
		a.$Scale == k && n.R(f, m.Pb, 1);
		a.$AutoCenter &= a.$Orientation;
		a.$AutoCenter && n.R(f, m.ob, a.$AutoCenter);
		n.dc(f)
	};
	...
	var i = j.$JssorSlider$ = function() {
		...
		var Fb = "data-jssor-slider",
			Vb = "data-jssor-thumb",
			v, n, G, mb, eb, sb, cb, R, N, L, Pb, kc, oc = 1,
			jc = 1,
			Xb = 1,
			ac = {},
			y, Y, Db, Rb, Ob, rb, fb, db, lb, s = -1,
			Ib, q, J, I, ob, yb, zb, ab, M, V, Z, x, W, xb, hb = [],
			fc, hc, bc, pc, Kc, u, nb, H, dc, wb, Gb, ec, T, P = 0,
			K = Number.MAX_VALUE,
			E = Number.MIN_VALUE,
			gc, C, pb, S, O = 1,
			bb, A, gb, Jb = 0,
			Kb = 0,
			Q, tb, ub, qb, w, jb, z, Lb, ib = [],
			Sb = b.$Device(),
			vb = Sb.Ye,
			B = [],
			D, U, F, Eb, Ub, X;
		...
		function wc(e, k, o) {
			...
			l.$ScaleSize = function(q, p, t) {
				...
				} else s = r = l = c.pow(N < L ? p : q, i.$Scale);
				b.Yf(a, l);
				b.$Attribute(a, m.Dc, l);
				b.$CssWidth(g, f.v * s);
				b.$CssHeight(g, f.u * r);
		...
		function zc(o, m) {
			...
			b.vd = function() {
				bb = d;
				gb = g;
				a.j(i.$EVT_SWIPE_START, t(w.db()), w.db())
			};
			b.td = function() {
				bb = k;
				j = k;
				var b = w.Of();
				a.j(i.$EVT_SWIPE_END, t(w.db()), w.db());
				if (!A) {
					Lc(b.Pf, s);
					(!b.wb || b.Qf) && ic(s, b.Jc)
				}
		...
		function Gc(m, f) {
			...
			function C(a) {
				...
				Q(m, a, 0);
				E = d;
				r = new eb.$Class(m, eb, b.T(m, "idle", dc), !u);
				r.D(0)
			}
				...
				if (!G) {
					...
					if (j && o) {
						var g = o.width,
							...
							l = c;
						if (g && c && n.$FillMode) {
							if (n.$FillMode & 3 && (!(n.$FillMode & 4) || g > J || c > I)) {
								var h = k,
									q = J / I * c / g;
			...
			e.Mb = function(e, c) {
				...
				if (y.length && !G) {
					...
					b.eg(y, j, b.$CreateCallback(g, N, e, c))
				} else N(e, c)
			};
			e.We = function() {
				if (q == 1) {
					...
					if (a) {
						var h = gb = b.W(),
							c = f + nb,
							d = B[t(c)];
						return d.Mb(b.$CreateCallback(g, T, c, d, a, h), x)
					}
				} else Nb(nb)
			};
			e.wc = function() {
			...
			function Q(a, f, c, h) {
				...
				b.$Each(i, function(a) {
					...
					if (g == "caption") {
						if (f) {
							b.zg(a, b.$AttributeEx(a, "to"));
							b.Uf(a, b.$AttributeEx(a, "bf"));
							H && b.$AttributeEx(a, "3d") && b.Tf(a, "preserve-3d")
						}
					} else if (!E && !c && !j) {
						if (e == "A") {
							if (b.$AttributeEx(a, "u") == "image") j = b.Zf(a, "IMG");
		...
		function Fc(z, g, p, q) {
			...
			function w() {
				b.zc(U);
				pc && m && o.kd && b.$AppendChild(U, o.kd);
				b.A(U, !m && o.nc)
			}
			...
			c.rd = function(a) {
				p && b.Ob(Z, a && p.xc.$Outside ? "" : "hidden")
			};
			c.Gc = function(c, b) {
				if (m && b >= h) {
					m = k;
		...
		function Cb(a) {
			if (!(C & 1)) a = c.min(K, c.max(a, E));
			return a
		}

		function Wb(a) {
			return !(C & 1) && (a - E < .0001 || K - a < .0001)
		}
		...
		function qc(g) {
			if (!A && (O || !(H & 12)) && !z.$IsPlaying()) {
				var b = w.db(),
					a = F,
					e = 0;
				if (g && c.abs(Q) >= n.$MinDragOffsetToSlide) {
					a = b;
					e = ub
				}
				if (Wb(b)) {
		...
		function Tb(a) {
			!b.Hb(b.$EvtSrc(a), "nodrag") && b.$CancelEvent(a)
		}
		...
		function mc(c, j) {
			...
			xb = k;
			var l = b.Hb(f, "1", Vb);
			if ((!l || l === v) && !W && (!j || c.touches.length == 1)) {
				xb = b.Hb(f, "nodrag") || !pb || !Ec();
				var n = b.Hb(f, e, m.Dc);
				if (n) Xb = b.$Attribute(n, m.Dc);
				if (j) {
					var p = c.touches[0];
					Jb = p.clientX;
					Kb = p.clientY
			...
			if (A) {
				...
				if (a) {
					...
					if (x || c.abs(e) > 1.5 || c.abs(f) > 1.5) {
						if (c.floor(F) != F) x = x || G & W;
						if ((e || f) && !x) {
							if (W == 3)
								if (c.abs(f) > c.abs(e)) x = 2;
								else x = 1;
							else x = W;
							if (vb && x == 1 && c.abs(f) > c.abs(e) * 2.4) xb = d
						}
						var n = f,
							i = zb;
						if (x == 1) {
		...
		function Ab(l, g, m, o) {
			if (!A && (O || !(H & 12)) || n.$NaviQuitDrag) {
				...
				if (!(C & 1)) {
					if (o) a = t(a);
					else if (C & 2 && (a < 0 && c.abs(b - E) < .0001 || a > q - V && c.abs(b - K) < .0001)) a = a < 0 ? K : E;
					a = Cb(a);
					if (K - a < .5) a = K;
					if (a - E < .5) a = E
				}
		...
		a.oc = function(O, m) {
			...
			G = n.$PlayOrientation & 3;
			mb = n.$SlideshowOptions;
			eb = b.q({
				$Class: r
			}, n.$CaptionSliderOptions);
			sb = n.$BulletNavigatorOptions;
			cb = n.$ArrowNavigatorOptions;
			R = n.$ThumbnailNavigatorOptions;
			!n.$UISearchMode;
			var s = b.$Children(v);
			b.$Each(s, function(a, d) {
				...
				if (c == "loading") Y = a;
					...
					if (c == "thumbnavigator") rb = a;
					if (a.tagName != "STYLE" && a.tagName != "SCRIPT") ac[c || d] = new wc(a, c == "slides", b.mg(["slides", "thumbnavigator"])[c])
				}
			});
			Y = Y || b.$CreateDiv(h);
			fb = b.$CssWidth(y);
			...
			wb = n.$SlideDuration;
			Lb = new Ac;
			if (n.$HWA && (!b.$IsBrowserFireFox() || vb)) Hb = function(a, c, d) {
				b.bc(a, {
					$TranslateX: c,
					$TranslateY: d
				})
			...
			b.Eb(Z, y);
			jb = new Hc;
			b.$AppendChild(Z, jb.Qb);
			b.Ob(y, "hidden");
			H &= vb ? 10 : 5;
			var x = b.$Children(y);
			b.$Each(x, function(a) {
				a.tagName == "DIV" && !b.$AttributeEx(a, "u") && ib.push(a);
				b.z(a, (b.z(a) || 0) + 1)
			});
			U = lc();
			b.$Css(U, "backgroundColor", "#000");
			b.uc(U, 0);
			b.z(U, 0);
			b.Eb(U, y.firstChild, y);
			q = ib.length;
			var l = c.ceil(((G & 1 ? fb : db) + ob) / ab);
			if (n.$Cols) l = n.$Cols;
			M = c.min(q, l);
			V = ((G & 1) * fb + (G & 2) * db / 2 + ob) / ab;
			gc = M < q;
			C = gc ? n.$Loop : 0;
			if (q) {
				uc();
				...
				if (mb) {
					pc = mb.$ShowLink;
					Gb = mb.$Class;
					ec = !T && M == 1 && q > 1 && Gb && (!b.$IsBrowserIE() || b.$BrowserVersion() >= 9)
				}
				if (!(C & 1)) {
					P = T / ab;
					E = P;
				...
				pb = (M > 1 || T ? G : -1) & n.$DragOrientation;
				Sb.sd && b.$Css(y, Sb.sd, ([g, "pan-y", "pan-x", "none"])[pb] || "");
				if (ec) D = new Gb(Lb, J, I, mb, vb, Hb);
				...
				b.$AddEvent(j, "mouseup", kb);
				b.$AddEvent(h, "mouseup", kb);
				b.$AddEvent(h, "touchend", kb);
				b.$AddEvent(h, "touchcancel", kb);
				b.$AddEvent(j, "blur", kb);
				if (Db && sb) {
					fc = new sb.$Class(Db, sb, N, L);
					hb.push(fc)
				}
				if (cb && Rb && Ob) {
					cb.$Loop = C;
					hc = new cb.$Class(Rb, Ob, cb, N, L, a);
					hb.push(hc)
				}
				if (rb && R) {
					R.$StartIndex = n.$StartIndex;
					R.$ArrowKeyNavigation = R.$ArrowKeyNavigation || 0;
					bc = new R.$Class(rb, R);
					!R.$NoDrag && b.$Attribute(rb, Vb, "1");
					hb.push(bc)
				}
				b.$Each(hb, function(a) {
					a.Cc(q, B, Y);
